...
public class WalletController {
    ...
    public ResponseEntity<List<WalletDto>> listWallets() {
        ...
        List<WalletDto> wallets = findAllWallets.findAllByUserId(userId);
    ...
    public ResponseEntity<WalletDto> getWallet(
        ...
        UUID userId = getCurrentUserId();
        WalletDto wallet = findWalletById.findByIdAndUserId(id, userId);
    ...
    public ResponseEntity<WalletDto> createWallet(
        ...
        UUID userId = getCurrentUserId();
        WalletDto wallet = createWallet.create(userId, request);
    ...
    public ResponseEntity<WalletDto> updateWallet(
        ...
        UUID userId = getCurrentUserId();
        WalletDto wallet = updateWallet.update(id, userId, request);
        return ResponseEntity.ok(wallet);
    }
