...
public interface GetCategoryBreakdown {
     ...
     */
    List<CategoryBreakdownDto> get(UUID userId, ReportFilter filter, TransactionType type);
     ...
     */
    List<CategoryBreakdownDto> getTopCategories(UUID userId, ReportFilter filter, TransactionType type, int limit);
}
