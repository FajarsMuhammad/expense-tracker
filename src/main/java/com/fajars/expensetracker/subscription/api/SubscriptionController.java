...
import com.fajars.expensetracker.subscription.usecase.upgradesubscription.UpgradeSubscription;
...
public class SubscriptionController {
    ...
    public ResponseEntity<SubscriptionStatusResponse> getStatus(
        ...
        log.debug("Getting subscription status for user: {}");

        Subscription subscription = getUserSubscription.getSubscription();
    ...
    public ResponseEntity<SubscriptionStatusResponse> getMySubscription(
        ...
        log.debug("GET /api/v1/subscriptions/me");
    ...
    public ResponseEntity<SubscriptionStatusResponse> startTrial() {
        log.info("Starting trial subscription");

        Subscription subscription = createTrialSubscription.createTrial();
    ...
    public ResponseEntity<UpgradeInfoResponse> upgrade() {
        log.info("User {} requesting premium upgrade");

        UpgradeInfoResponse response = upgradeSubscription.upgrade();
    ...
    public ResponseEntity<SubscriptionStatusResponse> cancel() {
        log.info("Cancelling subscription for user");
